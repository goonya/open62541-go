...
// WARNING: This file has automatically been generated on Tue, 31 Mar 2020 21:39:34 MSK.
...
func ServerWrite(server *Server, value *WriteValue) uint32 {
	cserver, _ := (*C.UA_Server)(unsafe.Pointer(server)), cgoAllocsUnknown
...
func ServerWriteValue(server *Server, nodeId NodeId, value Variant) uint32 {
	cserver, _ := (*C.UA_Server)(unsafe.Pointer(server)), cgoAllocsUnknown
...
func ServerSetNodeTypeLifecycle(server *Server, nodeId NodeId, lifecycle NodeTypeLifecycle) uint32 {
	cserver, _ := (*C.UA_Server)(unsafe.Pointer(server)), cgoAllocsUnknown
	cnodeId, _ := *(*C.UA_NodeId)(unsafe.Pointer(&nodeId)), cgoAllocsUnknown
...
func ServerAddObjectTypeNode(server *Server, requestedNewNodeId NodeId, parentNodeId NodeId, referenceTypeId NodeId, browseName QualifiedName, attr ObjectTypeAttributes, nodeContext unsafe.Pointer, outNewNodeId *NodeId) uint32 {
	cserver, _ := (*C.UA_Server)(unsafe.Pointer(server)), cgoAllocsUnknown
	crequestedNewNodeId, _ := *(*C.UA_NodeId)(unsafe.Pointer(&requestedNewNodeId)), cgoAllocsUnknown
	cparentNodeId, _ := *(*C.UA_NodeId)(unsafe.Pointer(&parentNodeId)), cgoAllocsUnknown
	creferenceTypeId, _ := *(*C.UA_NodeId)(unsafe.Pointer(&referenceTypeId)), cgoAllocsUnknown
