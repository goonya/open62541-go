...
func (s *ServerConfig) GetShutdownDelay() *Double {
	var ret *Double
	ret = (*Double)(unsafe.Pointer(&s.shutdownDelay))
	return ret
}
...
func (s *ServerConfig) GetRelaxEmptyValueConstraint() *Boolean {
	var ret *Boolean
	ret = (*Boolean)(unsafe.Pointer(&s.relaxEmptyValueConstraint))
	return ret
}
...
func (s *ServerConfig) GetMaxSessionTimeout() *Double {
	var ret *Double
	ret = (*Double)(unsafe.Pointer(&s.maxSessionTimeout))
	return ret
}
...
func (s *ServerConfig) GetEnableRetransmissionQueue() *Boolean {
	var ret *Boolean
	ret = (*Boolean)(unsafe.Pointer(&s.enableRetransmissionQueue))
	return ret
}
