...
// GetNThreads returns a reference to C object within a struct
func (s *ServerConfig) GetNThreads() *uint16 {
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.nThreads))
	return ret
}

// GetServerCertificate returns a reference to C object within a struct
func (s *ServerConfig) GetServerCertificate() *ByteString {
	var ret *ByteString
	ret = (*ByteString)(unsafe.Pointer(&s.serverCertificate))
	return ret
}

// GetShutdownDelay returns a reference to C object within a struct
func (s *ServerConfig) GetShutdownDelay() *float64 {
	var ret *float64
	ret = (*float64)(unsafe.Pointer(&s.shutdownDelay))
	return ret
}

// GetNetworkLayersSize returns a reference to C object within a struct
func (s *ServerConfig) GetNetworkLayersSize() *uint {
	var ret *uint
	ret = (*uint)(unsafe.Pointer(&s.networkLayersSize))
	return ret
}

// GetCustomHostname returns a reference to C object within a struct
func (s *ServerConfig) GetCustomHostname() *String {
	var ret *String
	ret = (*String)(unsafe.Pointer(&s.customHostname))
	return ret
}

// GetSecurityPoliciesSize returns a reference to C object within a struct
func (s *ServerConfig) GetSecurityPoliciesSize() *uint {
	var ret *uint
	ret = (*uint)(unsafe.Pointer(&s.securityPoliciesSize))
	return ret
}

// GetEndpointsSize returns a reference to C object within a struct
func (s *ServerConfig) GetEndpointsSize() *uint {
	var ret *uint
	ret = (*uint)(unsafe.Pointer(&s.endpointsSize))
	return ret
}

// GetRelaxEmptyValueConstraint returns a reference to C object within a struct
func (s *ServerConfig) GetRelaxEmptyValueConstraint() *bool {
	var ret *bool
	ret = (*bool)(unsafe.Pointer(&s.relaxEmptyValueConstraint))
	return ret
}

// GetMaxSecureChannels returns a reference to C object within a struct
func (s *ServerConfig) GetMaxSecureChannels() *uint16 {
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.maxSecureChannels))
	return ret
}

// GetMaxSecurityTokenLifetime returns a reference to C object within a struct
func (s *ServerConfig) GetMaxSecurityTokenLifetime() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxSecurityTokenLifetime))
	return ret
}

// GetMaxSessions returns a reference to C object within a struct
func (s *ServerConfig) GetMaxSessions() *uint16 {
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.maxSessions))
	return ret
}

// GetMaxSessionTimeout returns a reference to C object within a struct
func (s *ServerConfig) GetMaxSessionTimeout() *float64 {
	var ret *float64
	ret = (*float64)(unsafe.Pointer(&s.maxSessionTimeout))
	return ret
}

// GetMaxNodesPerRead returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNodesPerRead() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNodesPerRead))
	return ret
}

// GetMaxNodesPerWrite returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNodesPerWrite() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNodesPerWrite))
	return ret
}

// GetMaxNodesPerMethodCall returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNodesPerMethodCall() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNodesPerMethodCall))
	return ret
}

// GetMaxNodesPerBrowse returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNodesPerBrowse() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNodesPerBrowse))
	return ret
}

// GetMaxNodesPerRegisterNodes returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNodesPerRegisterNodes() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNodesPerRegisterNodes))
	return ret
}

// GetMaxNodesPerTranslateBrowsePathsToNodeIds returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNodesPerTranslateBrowsePathsToNodeIds() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNodesPerTranslateBrowsePathsToNodeIds))
	return ret
}

// GetMaxNodesPerNodeManagement returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNodesPerNodeManagement() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNodesPerNodeManagement))
	return ret
}

// GetMaxMonitoredItemsPerCall returns a reference to C object within a struct
func (s *ServerConfig) GetMaxMonitoredItemsPerCall() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxMonitoredItemsPerCall))
	return ret
}

// GetMaxReferencesPerNode returns a reference to C object within a struct
func (s *ServerConfig) GetMaxReferencesPerNode() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxReferencesPerNode))
	return ret
}

// GetMaxSubscriptions returns a reference to C object within a struct
func (s *ServerConfig) GetMaxSubscriptions() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxSubscriptions))
	return ret
}

// GetMaxSubscriptionsPerSession returns a reference to C object within a struct
func (s *ServerConfig) GetMaxSubscriptionsPerSession() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxSubscriptionsPerSession))
	return ret
}

// GetMaxNotificationsPerPublish returns a reference to C object within a struct
func (s *ServerConfig) GetMaxNotificationsPerPublish() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxNotificationsPerPublish))
	return ret
}

// GetEnableRetransmissionQueue returns a reference to C object within a struct
func (s *ServerConfig) GetEnableRetransmissionQueue() *bool {
	var ret *bool
	ret = (*bool)(unsafe.Pointer(&s.enableRetransmissionQueue))
	return ret
}

// GetMaxRetransmissionQueueSize returns a reference to C object within a struct
func (s *ServerConfig) GetMaxRetransmissionQueueSize() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxRetransmissionQueueSize))
	return ret
}

// GetMaxMonitoredItems returns a reference to C object within a struct
func (s *ServerConfig) GetMaxMonitoredItems() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxMonitoredItems))
	return ret
}

// GetMaxMonitoredItemsPerSubscription returns a reference to C object within a struct
func (s *ServerConfig) GetMaxMonitoredItemsPerSubscription() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxMonitoredItemsPerSubscription))
	return ret
}

// GetMaxPublishReqPerSession returns a reference to C object within a struct
func (s *ServerConfig) GetMaxPublishReqPerSession() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.maxPublishReqPerSession))
	return ret
}
...
func (s *String) GetLength() *uint {
	var ret *uint
	ret = (*uint)(unsafe.Pointer(&s.length))
	return ret
}

// GetData returns a reference to C object within a struct
func (s *String) GetData() **byte {
	var ret **byte
	ret = (**byte)(unsafe.Pointer(&s.data))
	return ret
}
...
// GetLength returns a reference to C object within a struct
func (s *ByteString) GetLength() *uint {
	var ret *uint
	ret = (*uint)(unsafe.Pointer(&s.length))
	return ret
}
...
// GetData returns a reference to C object within a struct
func (s *ByteString) GetData() **byte {
	var ret **byte
	ret = (**byte)(unsafe.Pointer(&s.data))
	return ret
}
...
// GetNamespaceIndex returns a reference to C object within a struct
func (s *NodeId) GetNamespaceIndex() *uint16 {
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.namespaceIndex))
	return ret
}
...
// GetNamespaceIndex returns a reference to C object within a struct
func (s *QualifiedName) GetNamespaceIndex() *uint16 {
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.namespaceIndex))
	return ret
}
...
func (s *QualifiedName) GetName() *String {
	var ret *String
	ret = (*String)(unsafe.Pointer(&s.name))
	return ret
}
...
// GetLocale returns a reference to C object within a struct
func (s *LocalizedText) GetLocale() *String {
	var ret *String
	ret = (*String)(unsafe.Pointer(&s.locale))
	return ret
}

// GetText returns a reference to C object within a struct
func (s *LocalizedText) GetText() *String {
	var ret *String
	ret = (*String)(unsafe.Pointer(&s.text))
	return ret
}
...
// GetTypeId returns a reference to C object within a struct
func (s *DataType) GetTypeId() *NodeId {
	var ret *NodeId
	ret = (*NodeId)(unsafe.Pointer(&s.typeId))
	return ret
}

// GetMemSize returns a reference to C object within a struct
func (s *DataType) GetMemSize() *uint16 {
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.memSize))
	return ret
}

// GetTypeIndex returns a reference to C object within a struct
func (s *DataType) GetTypeIndex() *uint16 {
	var ret *uint16
	ret = (*uint16)(unsafe.Pointer(&s.typeIndex))
	return ret
}

// GetMembersSize returns a reference to C object within a struct
func (s *DataType) GetMembersSize() *uint32 {
	var ret *uint32
	ret = (*uint32)(unsafe.Pointer(&s.membersSize))
	return ret
}
...
func (s *Variant) GetType() **DataType {
	var ret **DataType
	ret = (**DataType)(unsafe.Pointer(&s._type))
	return ret
}

// GetArrayLength returns a reference to C object within a struct
func (s *Variant) GetArrayLength() *uint {
	var ret *uint
	ret = (*uint)(unsafe.Pointer(&s.arrayLength))
	return ret
}

// GetData returns a reference to C object within a struct
func (s *Variant) GetData() *unsafe.Pointer {
	var ret *unsafe.Pointer
	ret = (*unsafe.Pointer)(unsafe.Pointer(&s.data))
	return ret
}

// GetArrayDimensionsSize returns a reference to C object within a struct
func (s *Variant) GetArrayDimensionsSize() *uint {
	var ret *uint
	ret = (*uint)(unsafe.Pointer(&s.arrayDimensionsSize))
	return ret
}

// GetArrayDimensions returns a reference to C object within a struct
func (s *Variant) GetArrayDimensions() **uint32 {
	var ret **uint32
	ret = (**uint32)(unsafe.Pointer(&s.arrayDimensions))
	return ret
}
